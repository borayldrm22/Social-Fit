...
2. **Domain mantığı (puan ekonomisi, streak kuralı, KVKK kısıtı) varsa** `.cursor/skills/social-fit-domain/SKILL.md` yükle.
...
7. `.cursor/skills/api-contract-check/SKILL.md` — kontrat eşleştirme adımları.
8. `.cursor/skills/backend-route-patterns/SKILL.md` — route yazım konvansiyonları.
...
Detay: `.cursor/skills/state-data-flow-patterns/SKILL.md`.
