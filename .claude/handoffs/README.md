...
1. Supervisor (sen) `_TEMPLATE.md`'i kopyala: `.claude/handoffs/<feature-slug>.md` (örn. `star-economy.md`)
...
Production'a giden feature'ların handoff dosyalarını **silme** — `.claude/handoffs/archive/` altına taşı. Geçmiş kararlar gelecekteki agent'lara değerli context.
