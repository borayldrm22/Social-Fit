...
1. `.cursor/rules/social-fit-project.mdc` (proje kökünde) zaten yüklü — ürün bağlamı orada.
2. `.cursor/skills/social-fit-domain/SKILL.md` — vizyon, hedef kullanıcı, 5 fazlı roadmap, monetizasyon. Faz 4-5 pazarlama işidir, **her zaman yükle**.
3. `.cursor/skills/marketing/mkt-strategy/SKILL.md` — AARRR funnel, ICP, konumlandırma, rakip açısı, brief şablonu.
4. `.cursor/skills/marketing/mkt-brand-voice/SKILL.md` — marka sesi ve KVKK-güvenli dil sınırı.
5. `.cursor/skills/marketing/mkt-metrics/SKILL.md` — hangi metrik hedefe kilitlenecek (north-star, CAC, retention).
6. Deney roadmap'i gerekiyorsa `.cursor/skills/marketing/mkt-experiments/SKILL.md` yükle.
...
6. Non-trivial kampanyaysa `.cursor/handoffs/` altında `_CAMPAIGN_TEMPLATE.md`'yi kopyalayıp brief bölümünü doldur, kanal uzmanlarına @mention ile pas ver.
