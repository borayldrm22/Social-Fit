...
1. Proje bağlamı: `.cursor/rules/social-fit-project.mdc` veya `CLAUDE.md`.
2. `.cursor/skills/qa-review-checklist/SKILL.md` — kontrol listesi burada.
3. `.cursor/skills/feature-delivery-checklist/SKILL.md` — Definition of Done burada.
4. Varsa `.cursor/handoffs/<feature-slug>.md` — feature'ın handoff dosyasını oku.
...
Şunlardan birini gördüğünde doğrudan düzeltmek istersen dosya düzenleyebilirsin — ama sadece:
