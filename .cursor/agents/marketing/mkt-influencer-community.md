...
2. `.cursor/skills/marketing/mkt-influencer/SKILL.md` — sourcing kriterleri, tier'lar, DM şablonları, collab brief, ifşa/KVKK. **Her zaman yükle.**
3. `.cursor/skills/social-fit-domain/SKILL.md` — diyetisyen rezervasyonu ve kanal/grup ürün özelliği; partnerlik bununla bağlanır.
4. `.cursor/skills/marketing/mkt-brand-voice/SKILL.md` — DM tonu.
5. Davet/referral hedefi varsa `.cursor/skills/marketing/mkt-referral-viral/SKILL.md` yükle.
