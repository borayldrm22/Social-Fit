...
1. Proje bağlamı: `.cursor/rules/social-fit-project.mdc` veya `CLAUDE.md` (proje kökünde).
2. **Yeni feature veya UX kararı varsa** `.cursor/skills/social-fit-domain/SKILL.md` yükle (onboarding modeli, gamification kuralları, ilham app'leri).
...
4. `.cursor/skills/ui-design-system/SKILL.md` skill'ini yükle: token kullanım kuralları orada.
5. `.cursor/skills/mobile-screen-patterns/SKILL.md` skill'ini yükle: header/card/CTA/list pattern'leri orada.
