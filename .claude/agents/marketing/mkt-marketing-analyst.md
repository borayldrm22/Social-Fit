...
1. `CLAUDE.md` yüklü.
2. `.claude/skills/marketing/mkt-metrics/SKILL.md` — CAC, LTV, retention tanımları, north-star, analist checklist'i. **Her zaman yükle.**
3. `.claude/skills/marketing/mkt-campaign-checklist/SKILL.md` — kampanya Definition of Done.
4. Deney sonuçlarını okuyacaksan `.claude/skills/marketing/mkt-experiments/SKILL.md` yükle.
5. Retention/referral etkisi ölçülecekse `.claude/skills/marketing/mkt-lifecycle-retention/SKILL.md` ve `.claude/skills/marketing/mkt-referral-viral/SKILL.md` yükle.
