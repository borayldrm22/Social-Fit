...
2. `.cursor/skills/marketing/mkt-aso/SKILL.md` — store metadata alanları, TR keyword araştırma, screenshot stratejisi, A/B. **Store işinde yükle.**
3. `.cursor/skills/marketing/mkt-content-seo/SKILL.md` — blog konu kümeleri, SEO, landing/waitlist copy. **İçerik/SEO işinde yükle.**
4. `.cursor/skills/marketing/mkt-brand-voice/SKILL.md` — ton ve KVKK sınırı.
5. `.cursor/skills/social-fit-domain/SKILL.md` — konumlandırma ve rakipler (MyFitnessPal, Lifesum, Supatrack).
