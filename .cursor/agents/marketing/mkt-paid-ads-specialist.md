...
2. `.cursor/skills/marketing/mkt-paid-ads/SKILL.md` — kanal yapısı, kreatif spec'leri, bütçe/bidding, UTM. **Her zaman yükle.**
3. `.cursor/skills/marketing/mkt-brand-voice/SKILL.md` — ton ve KVKK sınırı.
4. `.cursor/skills/marketing/mkt-metrics/SKILL.md` — CAC, ROAS, hangi eyleme optimize edilecek.
5. `.cursor/skills/marketing/mkt-copy-patterns/SKILL.md` — reklam başlık/CTA formülleri.
6. Deney backlog'u yönetilecekse `.cursor/skills/marketing/mkt-experiments/SKILL.md` yükle.
